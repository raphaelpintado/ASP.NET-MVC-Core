...
namespace DevIO.App.Extensions
{
    ...
    public class ApagaElementoByClaimTagHelper : TagHelper
    {
        ...
        public string IndentityClaimValue { get; set; }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var temAcesso = CustomAuthorization.ValidarClaimsUsuario(_contextAccessor.HttpContext, IdentityClaimName, IndentityClaimValue);
